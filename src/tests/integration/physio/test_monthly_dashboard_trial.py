...
class TestPhysioMonthlyDashboardTrial(IntegrationBaseTest):
    path = "/v1/physio/dashboard"

    data_sources = [
        'integration/default-users',
        'integration/physio/progress-month-trial/game-sessions',
        'integration/physio/progress-month-trial/streaks',
        'integration/physio/progress-month-trial/users'
    ]
            ...
            'actions': {
                'current_week': {
                    ...
                    'params': {
                        ...
                        'period_aggregator': '2021-04-01T10:50:17.561547'
                    }
                },
                'prev': {
                    'href': '/v1/physio/dashboard',
                    'params': {
                        ...
                        'period_aggregator': '2021-03-01T10:50:17.561547+00:00'
                    }
                },
            },
                            ...
                            'metrics': [
                                {
                                    ...
                                    "is_increased": True,
                                    "percent": "65.5%",
                                    'subtitle': "19 minutes more than previous period"
                                },
                            ],
                        },
                        {
    ...
    @freeze_time("2021-04-1T10:50:17.561547")
