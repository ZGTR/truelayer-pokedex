...
class DailyUserRankingAllMultiUserTest(IntegrationBaseTest):
    ...
    data_sources = [
        ...
        'integration/user/progress-day-current/day_leaderboard_leaderboard_stale',
    ...
    def test_getTodayRankingMultiUser12(self):
        ...
        expected_response = {
            'rankings': [
                ...
                {'user_id': '806', 'username': 'Atan06', 'sum_score': 320, 'sum_reps': 170, 'sum_minutes': 150, 'streak': {'streak_days': 0, 'is_streaked_today': False}, 'position': 13},
                {'user_id': '805', 'username': 'Atan05', 'sum_score': 310, 'sum_reps': 160, 'sum_minutes': 150, 'streak': {'streak_days': 0, 'is_streaked_today': False}, 'position': 14},
                {'user_id': '804', 'username': 'Atan04', 'sum_score': 300, 'sum_reps': 150, 'sum_minutes': 150, 'streak': {'streak_days': 0, 'is_streaked_today': False}, 'position': 15},
                {'user_id': '808', 'username': 'Atan08', 'sum_score': 0, 'sum_reps': 0, 'sum_minutes': 0, 'streak': {'streak_days': 0, 'is_streaked_today': False}, 'position': 16},
                {'user_id': '807', 'username': 'Atan07', 'sum_score': 0, 'sum_reps': 0, 'sum_minutes': 0, 'streak': {'streak_days': 0, 'is_streaked_today': False}, 'position': 17}
    ...
    def test_getTodayRankingMultiUser03HasBots(self, mock_choice, mock_randbelow):
        ...
        expected_response = {
            'rankings': [
                ...
                {'user_id': '805', 'username': 'Atan05', 'sum_score': 310, 'sum_reps': 160, 'sum_minutes': 150, 'streak': {'streak_days': 0, 'is_streaked_today': False}, 'position': 14},
                {'user_id': '804', 'username': 'Atan04', 'sum_score': 300, 'sum_reps': 150, 'sum_minutes': 150, 'streak': {'streak_days': 0, 'is_streaked_today': False}, 'position': 15},
                {'user_id': '803', 'username': 'Atan03', 'sum_score': 0, 'sum_reps': 0, 'sum_minutes': 0, 'is_you': True, 'streak': {'streak_days': 0, 'is_streaked_today': False}, 'position': 16},
                {'user_id': '808', 'username': 'Atan08', 'sum_score': 0, 'sum_reps': 0, 'sum_minutes': 0, 'streak': {'streak_days': 0, 'is_streaked_today': False}, 'position': 17},
                {'user_id': '807', 'username': 'Atan07', 'sum_score': 0, 'sum_reps': 0, 'sum_minutes': 0, 'streak': {'streak_days': 0, 'is_streaked_today': False}, 'position': 18},
